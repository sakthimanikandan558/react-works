...
const Login = () => {
    ...
    const handleGoogleLogin = async () => {
        ...
        // Handle Google callback after redirection
        useEffect(() => {
            const handleGoogleCallback = async () => {
                ...
                if (token) {
                    try {
                        ...
                        // Update context and navigate to welcome
                        login(user.first_name, token);
                        navigate("/welcome");
                    } catch (error) {
                        console.error("Error fetching user data after callback:", error);
                    }
                }
            };
    ...
    style={{ 
        ...
        <div className='bg-white w-full max-w-md rounded-lg mx-4'
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div onClick={handleGoogleLogin} className='flex justify-center cursor-pointer items-center mt-2 border-[2px] rounded-md border-slate-300 hover:border-blue-500 w-[90%] mx-auto'>
